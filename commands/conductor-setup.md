...
2.  **Customize Workflow:**
    ...
    -   If the user chooses to **customize** (Option B):
        ...
        -   **Question 3:** "Do you want to use git notes or the commit message to record the task summary?"
            ...
            -   B) Commit Message
        -   **Question 4:** "Do you want to enable automated review at the end of each track? This will automatically trigger `/conductor:review` after each track completion."
            -   A) Yes (Enable automated review - Recommended)
            -   B) No (Disable automated review)
